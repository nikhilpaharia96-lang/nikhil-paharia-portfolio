  ...
  return (
    <section ref={ref} className="relative min-h-screen flex items-center overflow-hidden w-full max-w-full section-wrap" id="home">
      ...
      <div className="absolute inset-0 z-0">
        <img src={teaBg} alt="" className="w-full h-full object-cover" style={{ filter: 'brightness(0.78) saturate(0.65)' }} />
      ...
      <div className="relative z-10 w-full max-w-7xl mx-auto px-6 sm:px-8 lg:px-6">
        <div className="grid lg:grid-cols-[1fr_auto_auto] gap-6 lg:gap-12 items-center pt-24 pb-16 lg:pt-0 lg:pb-0 lg:min-h-screen">
          ...
          >
            ...
            {/* Cursive tagline — matches reference handwriting style, uses existing Caveat import */}
            <motion.div
            ...
            >
              ...
              >
                ...
                {/* subtle hand-drawn underline swoop, like the "Assam" underline in your code */}
                <path
            ...
            <div className="grid grid-cols-3 gap-3 mt-6 lg:hidden">
              {stats.map(({ value, label, sub, Icon, color, bg }) => (
                ...
                >
                  ...
                  <div className="font-bold leading-tight" style={{ color, fontSize: 'clamp(1rem, 4.5vw, 1.3rem)' }}>{value}</div>
          ...
          >
            {stats.map(({ value, label, sub, Icon, color, bg }, i) => (
              ...
              >
                ...
                <div>
                  <div className="text-xl font-bold text-foreground leading-none mb-0.5" style={{ color }}>{value}</div>
